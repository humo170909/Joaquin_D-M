...
function loadKpis() {
  ...
  document.getElementById('viajesKpis').innerHTML = `
    ...
    <div class="kpi-card purple"><div class="kpi-header"><div class="kpi-label">Semana</div><div class="kpi-icon">📊</div></div><div class="kpi-value">${semana}</div><div class="kpi-footer">Esta semana</div></div>
    <div class="kpi-card teal"><div class="kpi-header"><div class="kpi-label">Mes</div><div class="kpi-icon">🗓</div></div><div class="kpi-value">${mes}</div><div class="kpi-footer">Este mes</div></div>
    <div class="kpi-card green"><div class="kpi-header"><div class="kpi-label">Completados</div><div class="kpi-icon">✅</div></div><div class="kpi-value">${completados}</div><div class="kpi-footer">Total completados</div></div>
...
function openModalViaje(data = null) {
  ...
  document.getElementById('viajeFecha').value            = data?.fecha || new Date().toISOString().split('T')[0];
